"""
ClassDesc PROJECT
Tool for generating source code on Python/Kotlin from class description file *.dsc.
...
Options:
    ...
    -l, --target-lan=LANGUAGE           Source code language to generate - now only support `python` and `kotlin`.
