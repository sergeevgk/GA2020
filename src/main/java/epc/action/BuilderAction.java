...
import epc.dialogs.SelectStuffDialog;
import epc.generator.BuilderGenerator;
import epc.renderer.NameListCelRenderer;
...
public class BuilderAction extends EpcAction {
    ...
    private void generateCode(PsiClass psiClass, List<PsiField> includedFields, List<PsiField> mandatoryFields) {
        WriteCommandAction.runWriteCommandAction(psiClass.getProject(), () -> new BuilderGenerator(psiClass, includedFields, mandatoryFields).generateJavaClass());
    }
