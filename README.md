...
ФАН: автор, название, дата, статус
...
ФАН: без анализа перекидываем в DOT - правильное решение. Не знаешь, что можно, а что нельзя писать в DOT - не пиши ничего!
...
ФАН: Очень хочется увидеть этот автомат в форме графа переходов состояний!
...
ФАН: хорошо бы отрисовать один из примеров деревьев, которые есть в слайдах к курсу
