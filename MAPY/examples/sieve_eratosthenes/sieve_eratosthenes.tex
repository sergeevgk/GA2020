...
$\text{\color{gray} {// Для построения множества простых чисел}} {\color{gray} {,}} \text{\color{gray} { не превосходящих данного числа }} {\color{gray} {n,}} $

$\text{\color{gray} {// используют простой способ}} {\color{gray} {,}} \text{\color{gray} { называемый решетом Эратосфена}} {\color{gray} {.}} $
